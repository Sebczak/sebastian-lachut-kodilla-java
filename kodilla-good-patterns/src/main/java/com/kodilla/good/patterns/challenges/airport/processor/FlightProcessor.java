...
public class FlightProcessor {
    ...
    public FlightDto checkFlight(FlightRequest flightRequest) {
        ...
        List<Flight> connectingFlights = flightService.findFlightsThroughCity(allFlights, flightRequest.getDepartureCity(), flightRequest.getPlaneStopCity(), flightRequest.getDestinationCity());
